...
<body style="background-color:lightgray">
	...
	<%
		List<Product> list = new ProductDaoImpl().getProductsByCategory("XBox-One");
		session.setAttribute("XBoxOneProducts", list);
	%>
	
<jsp:include page="UserHeader.jsp"></jsp:include>

<div class="container">
	<c:forEach items="${XBoxOneProducts}" var="current">
	<div class="row">
